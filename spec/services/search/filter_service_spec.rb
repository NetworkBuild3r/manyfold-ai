...
RSpec.describe Search::FilterService do
  context "with a range of models" do
    ...
    before do
      create(:model, name: "cat in the hat", path: "cat_in_hat", tag_list: ["dog", "log", "frog", "cat"], creator: creator, notes: "lorem ipsum", caption: nil)
      create(:model, name: "hat on the cat", path: "hat_on_cat", tag_list: [], creator: creator, notes: nil, caption: "dolor sit amet")
      create(:model, name: "bat on a mat", path: "bat_on_mat", tag_list: ["log"], collection: collection, notes: nil, caption: nil, links_attributes: [{url: "https://thingiverse.com/thing:1234"}])
      create(:model, name: "bat on a hat", path: "bat_on_hat", tag_list: ["frog"], collection: collection, notes: nil, caption: nil, owner: contributor)
    end
