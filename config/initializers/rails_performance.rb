...
#
# Skip constants + SidekiqExt prepend load in every env (including test) so RSpec can assert
# without requiring full RailsPerformance.setup. Redis/duration setup stays out of test /
# asset precompile.
