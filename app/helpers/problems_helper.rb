module ProblemsHelper
  ...
  def problem_icon_tag(problems)
    ...
    content_tag(:span, Icon(icon: ico, label: t("problems.severities.#{severity}")), class: "tw:text-#{severity} tw:align-middle") if ico # rubocop:todo I18n/RailsI18n/DecorateStringFormattingUsingInterpolation
  end
end
